...
export function Sidebar() {
  ...
  return (
    <>
      {collapsed ? (
        <div className="w-10 flex-none flex flex-col items-center border-r border-zinc-700 bg-zinc-900 pt-2.5">
          <button
            onClick={() => setCollapsed(false)}
            title="Expand sidebar"
            className="w-6 h-6 flex items-center justify-center text-zinc-500 hover:text-zinc-200 hover:bg-zinc-700 rounded transition-colors text-sm"
          >
            ›
          </button>
        </div>
      ) : (
        <aside className="w-64 flex-none border-r border-zinc-700 flex flex-col h-full overflow-y-auto bg-zinc-900">
          <div className="flex items-center justify-between px-3 h-12 border-b border-zinc-700 shrink-0">
            ...
            <div className="flex items-center gap-0.5">
              ...
              <button
                ...
                className="text-zinc-500 hover:text-zinc-200 w-6 h-6 flex items-center justify-center rounded hover:bg-zinc-700 transition-colors text-sm"
              >
                ‹
              </button>
            </div>
